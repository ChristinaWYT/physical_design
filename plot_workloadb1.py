...
ax2 = ax1.twinx()
p2, = ax2.plot([1,2,3], workloadb_avg_latency, color='b', marker='o', label="workloadb average latency")
ax3 = ax1.twinx()
p3, = ax3.plot([1,2,3], workloadb_min_latency, color='g', marker='o', label="workloadb min latency")
ax4 = ax1.twinx()
p4, = ax4.plot([1,2,3], workloadb_max_latency, color='k', marker='o', label="workloadb max latency")
