...
class MyHeapMemoryTunerImpl5 implements HeapMemoryTuner {
  ...
  public static float CACHEVALUE=.5f;
  ...
  private static RandomAccessFile cachevalue = null;
  ...
  public TunerResult tune(TunerContext context) {
    ...
    try {
      ...
      cachevalue =  new RandomAccessFile("/home/hadoop/hbase/cachevaluefile", "r");
      eviction_thresholdfile = new RandomAccessFile("/home/hadoop/hbase/evict_thresholdfile","r");
      CACHEVALUE = getThreshold(cachevalue);
    ...
    newBlockCacheSize=CACHEVALUE;
    newMemstoreSize=0.8f - CACHEVALUE;
