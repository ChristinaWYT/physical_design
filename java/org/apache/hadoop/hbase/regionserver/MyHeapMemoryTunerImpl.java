...
class MyHeapMemoryTunerImpl implements HeapMemoryTuner {
  ...
  public TunerResult tune(TunerContext context) {
	...
	System.out.println("selfdapql probability ratio: " + ratio);
      ...
      double normalized_blockCacheEvictionCount = pc_by_pm * am_blockCacheEvictionCount;
      double normalized_count_diff = normalized_blockCacheEvictionCount - rslog_blocking_updates_count;
