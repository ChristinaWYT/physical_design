...
p1, = ax1.plot([1,2,3], load_throughputs, color='r', marker='o', label="load throughput", linewidth=1.5)
ax2 = ax1.twinx()
p2, = ax2.plot([1,2,3], load_avg_latency, color='b', marker='o', label="load average latency", linewidth=1.5)
ax3 = ax1.twinx()
p3, = ax3.plot([1,2,3], load_min_latency, color='g', marker='o', label="load min latency", linewidth=1.5)
ax4 = ax1.twinx()
p4, = ax4.plot([1,2,3], load_max_latency, color='k', marker='o', label="load max latency", linewidth=1.5)
