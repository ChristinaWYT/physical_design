...
p1, = ax1.plot([1,2,3], random_read_throughputs, color='r', marker='o', label="random_read throughput", linewidth=1.5)
ax2 = ax1.twinx()
p2, = ax2.plot([1,2,3], random_read_avg_latency, color='b', marker='o', label="random_read average latency", linewidth=1.5)
ax3 = ax1.twinx()
p3, = ax3.plot([1,2,3], random_read_min_latency, color='g', marker='o', label="random_read min latency", linewidth=1.5)
ax4 = ax1.twinx()
p4, = ax4.plot([1,2,3], random_read_max_latency, color='k', marker='o', label="random_read max latency", linewidth=1.5)
