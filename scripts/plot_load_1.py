...
p1, = ax1.plot([1,2,3], load_throughputs[0:3], color='r', marker='o', label="insert", linewidth=1.5)
ax1.plot([1,2,3], load_throughputs[3:6], color='r', marker='s', label="insert", linewidth=1.5)
ax2 = ax1.twinx()
p2, = ax2.plot([1,2,3], number_bytes_written[0:3], color='b', marker='o', label="byte written",linewidth=1.5)
ax2.plot([1,2,3], number_bytes_written[3:6], color='b', marker='s', label="byte written", linewidth=1.5)
ax3 = ax1.twinx()
p3, = ax3.plot([1,2,3], number_of_compaction[0:3], color='g', marker='o', label="number of compaction", linewidth=1.5)
ax3.plot([1,2,3], number_of_compaction[3:6], color='g', marker='s', label="number of compaction", linewidth=1.5)
ax4 = ax1.twinx()
p4, = ax4.plot([1,2,3], number_storeFiles[0:3], color='k', marker='o', label="number of storeFiles", linewidth=1.5)
p4, = ax4.plot([1,2,3], number_storeFiles[3:6], color='k', marker='s', label="number of storeFiles", linewidth=1.5)
ax5 = ax1.twinx()
p5, = ax5.plot([1,2,3], number_bytes_read[0:3], color='c', marker='o', label="byte read", linewidth=1.5)
p5, = ax5.plot([1,2,3], number_bytes_read[3:6], color='c', marker='s', label="byte read", linewidth=1.5)
