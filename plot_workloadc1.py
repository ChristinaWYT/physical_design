...
p1, = ax1.plot([1,2,3], workloadc_throughputs, color='r', marker='o', label="workloadc throughput")
ax2 = ax1.twinx()
p2, = ax2.plot([1,2,3], workloadc_avg_latency, color='b', marker='o', label="workloadc average latency")
ax3 = ax1.twinx()
p3, = ax3.plot([1,2,3], workloadc_min_latency, color='g', marker='o', label="workloadc min latency")
ax4 = ax1.twinx()
p4, = ax4.plot([1,2,3], workloadc_max_latency, color='k', marker='o', label="workloadc max latency")
...
pyplot.savefig('workloadc_latency_' + args.cases + '.png')
pyplot.show()
