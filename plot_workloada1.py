...
ax2 = ax1.twinx()
p2, = ax2.plot([1,2,3], workloada_avg_latency, color='b', marker='o', label="workloada average latency")
ax3 = ax1.twinx()
p3, = ax3.plot([1,2,3], workloada_min_latency, color='g', marker='o', label="workloada min latency")
ax4 = ax1.twinx()
p4, = ax4.plot([1,2,3], workloada_max_latency, color='k', marker='o', label="workloada max latency")
