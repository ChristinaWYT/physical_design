...
counter=1
localcounter=1
with open('plot_workloadc373839.dat','r') as file:
	for line in file:
...
localcounter=1
counter=counter+1
with open('plot_workloadc404142.dat','r') as file:
	for line in file:
		data_dict[counter, localcounter]=line.strip().split(',')
		print(data_dict[(counter, localcounter)])
		localcounter=localcounter+1
...
localcounter=1
counter=counter+1
with open('plot_workloadc434445.dat','r') as file:
	for line in file:
		data_dict[counter, localcounter]=line.strip().split(',')
		print(data_dict[(counter, localcounter)])
		localcounter=localcounter+1
...
counter=counter+1
localcounter=1
with open('plot_workloadc464748.dat','r') as file:
	for line in file:
		data_dict[counter, localcounter]=line.strip().split(',')
		print(data_dict[(counter, localcounter)])
		localcounter=localcounter+1
...
pyplot.title('Avg 1')
pyplot.savefig('plot_workloadc_avg_1', bbox_inches='tight', pad_inches=0.2)
