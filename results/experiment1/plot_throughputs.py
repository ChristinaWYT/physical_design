...
for i in range(1,10):
	with open('results/experiment1/load_' + str(i) + '.dat', 'r') as file:
		for line in file:
			words = line.split()
			if len(words) == 3:
...
for i in range(1,10):
	with open('results/experiment1/random_read_' + str(i) + '.dat', 'r') as file:
		for line in file:
			words = line.split()
			if len(words) == 3:
				if words[0] == '[OVERALL],' and words[1] == 'Throughput(ops/sec),':
...
for i in range(1,10):
	with open('results/experiment1/scan_' + str(i) + '.dat', 'r') as file:
		for line in file:
			words = line.split()
			if len(words) == 3:
				if words[0] == '[OVERALL],' and words[1] == 'Throughput(ops/sec),':
...
pyplot.savefig('results/experiment1/throughputs.png')
pyplot.show()
