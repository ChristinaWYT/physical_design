...
counter=1
localcounter=1
with open('plot_workloadc_latency343536.dat','r') as file:
	for line in file:
...
with open('plot_workloadc_latency373839.dat','r') as file:
	for line in file:
		data_dict[counter, localcounter]=line.strip().split(',')
		print(data_dict[(counter, localcounter)])
		localcounter=localcounter+1
...
localcounter=1
counter=counter+1
with open('plot_workloadc_latency404142.dat','r') as file:
	for line in file:
		data_dict[counter, localcounter]=line.strip().split(',')
		print(data_dict[(counter, localcounter)])
		localcounter=localcounter+1
...
localcounter=1
counter=counter+1
with open('plot_workloadc_latency434445.dat','r') as file:
	for line in file:
		data_dict[counter, localcounter]=line.strip().split(',')
		print(data_dict[(counter, localcounter)])
		localcounter=localcounter+1
...
counter=counter+1
localcounter=1
with open('plot_workloadc_latency464748.dat','r') as file:
	for line in file:
		data_dict[counter, localcounter]=line.strip().split(',')
		print(data_dict[(counter, localcounter)])
		localcounter=localcounter+1
...
pyplot.title('avg1')
pyplot.savefig('workloadc_avg_latency_1' ,  bbox_inches='tight', pad_inches=0.2)
#pyplot.show()
